...
<table width="100%" className='mt-10 general_clean_items'>
             ...
             <div className='mt-12'>
                ...
                <textarea id="w3review" name="w3review" rows="4" cols="50" placeholder='Type here....' className='custom_textarea w-[500px] h-[250px] sm:w-full sm:h-[100px]'></textarea>
                    ...
                    <h4 className='font-bold'>Upload Pictures</h4>
                        <div className='w-[500px] h-[250px] sm:w-full sm:h-[100px] border-2 border-dashed mt-4 border-grey-500 rounded-2xl  center_image'>
